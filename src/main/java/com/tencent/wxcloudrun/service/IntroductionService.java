...
public interface IntroductionService {
     ...
     * @return 是否删除成功
     */
    boolean deleteIntroductionByOpenId();
     ...
     * @return 创建好的新简历
     */
    IntroductionDTO createIntroduction(IntroductionDTO introductionDTO);
     ...
     * @return 更新后的简历信息
     */
    IntroductionDTO updateIntroduction(IntroductionDTO introductionDTO);
}
